...
interface ImportMetaEnv {
  ...
  readonly VITE_GOOGLE_API: string; // Google API base URL (https://maps.googleapis.com/maps/api) [Needs Places API only to be enabled]
  readonly VITE_GOOGLE_API_KEY: string; // Google API key
